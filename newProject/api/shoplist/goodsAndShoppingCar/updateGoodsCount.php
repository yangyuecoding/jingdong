 ...
 * @Version: 版本更新中...
 * @Autor: YangYi
 * @Date: 2020-05-27 19:36:13
 * @LastEditors: YangYi
 * @LastEditTime: 2020-05-27 20:02:04
 */ 
	...
	//2）、选择数据库（找目的地）
	if(!mysql_select_db("jingdongdb",$conn)){
		die("数据库选择失败".mysql_error());
	}
	
	//3）、传输数据（过桥）
	$sqlstr = "update jingdongdb set goodsCount='".$goodsCount."' where vipName='".$vipName."' and goodsId='".$goodsId."'";
	//echo($sqlstr);
